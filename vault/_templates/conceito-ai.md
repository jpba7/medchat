...
2-4 linhas explicando o conceito em si, sem jargão. Suficiente pra quem nunca ouviu falar entender.
...
- [`docs/ai-engineering/<NN>-<nome>.md`](../../docs/ai-engineering/) — pedagogia longa, se existe.
